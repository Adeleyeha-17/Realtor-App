...
export default function SignIn() {
  ...
  return (
    <section>
      ...
      <div className="flex justify-center flex-wrap items-center px-8 py-12 max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-[60%] lg:w-[40%] lg:ml-20 items-center justify-center">
